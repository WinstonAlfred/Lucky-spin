...
import { SelectHuaweiWinner, getParticipants } from '@/actions/participant';
...
export function HuaweiLotterySection() {
  const [huaweiWinner, setHuaweiWinner] = useState<Participant | null>(null);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 p-4">
      ...
      <Button 
        ...
        disabled={isSelectingHuawei || participants.length === 0}
      ...
      >
        {isSelectingHuawei ? '🎰 Rolling the Lucky Draw...' : '🎰 Start Lucky Draw'}
      </Button>

      {huaweiWinner && !isSelectingHuawei && (
...
export default HuaweiLotterySection;